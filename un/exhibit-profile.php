...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Exhibit Profile" />
    <meta name="description" content="Exhibit Profile">
    <meta name="author" content="Exhibit Profile">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Exhibit Profile</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Exhibit Profile</h2>                                   
  </div><!-- .container -->
</section>
