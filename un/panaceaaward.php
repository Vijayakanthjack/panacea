...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Panacea Awards" />
    <meta name="description" content="Panacea Awards">
    <meta name="author" content="Panacea Awards">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Panacea Awards</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Panacea Awards</h2>                                   
  </div><!-- .container -->
</section>
