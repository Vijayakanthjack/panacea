...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Travel & Accomodation" />
    <meta name="description" content="Travel & Accomodation">
    <meta name="author" content="Travel & Accomodation">
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Travel & Accomodation</h2>                                   
  </div><!-- .container -->
</section>
