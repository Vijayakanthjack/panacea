...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Visiting | Why Visit?" />
    <meta name="description" content="Visiting | Why Visit?">
    <meta name="author" content="Visiting | Why Visit?">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Visiting | Why Visit?</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Visiting | Why Visit?</h2>                                   
  </div><!-- .container -->
</section>
