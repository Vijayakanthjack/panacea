...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Visiting | Add Dates To Diary" />
    <meta name="description" content="Visiting | Add Dates To Diary">
    <meta name="author" content="Visiting | Add Dates To Diary">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Visiting | Add Dates To Diary</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Visiting | Add Dates To Diary</h2>                                   
  </div><!-- .container -->
</section>
