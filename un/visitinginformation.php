...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Visiting | Visiting Information" />
    <meta name="description" content="Visiting | Visiting Information">
    <meta name="author" content="Visiting | Visiting Information">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Visiting | Visiting Information</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Visiting | Visiting Information</h2>                                   
  </div><!-- .container -->
</section>
