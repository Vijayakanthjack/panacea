...
<html lang="en">
   <head>
    ...
    <meta name="keywords" content="Visiting | Visitor Registration" />
    <meta name="description" content="Visiting | Visitor Registration">
    <meta name="author" content="Visiting | Visitor Registration">

    <link rel="icon" href="public/images/h2m-fav.png" type="image/x-icon" />
      <title>Visiting | Visitor Registration</title>
...
<section class="section-heading" style="background-image:url('public/images/innercollage.jpg')">
  <div class="container-fluid">
    <h2 class="title wow zoomIn animated" wow-data-duration="0.8s" style="visibility: visible;">Visiting | Visitor Registration</h2>                                   
  </div><!-- .container -->
</section>
